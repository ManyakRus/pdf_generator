...
import (
	...
	"errors"
	"fmt"
	"github.com/ManyakRus/pdf_generator/internal/v0/app/create_file"
	"github.com/ManyakRus/pdf_generator/internal/v0/app/types"
...
func SubscribeTopics() {
	...
	if err != nil {
		...
		log.Info("SubscribeTopics() OK. URL: ", nats_connect.Settings.NATS_HOST, " Subject:", TOPIC_PDF_IN)
	}
